...
function rbw_list() {
    ...
    local fzf_args=(
        ...
        --bind="ctrl-u:execute-silent(rbw get {} --field username --clipboard)+execute-silent(touch ${TIMESTAMP_FILE})+transform-input-label(echo \"Copied username\")"
        --bind="ctrl-p:execute-silent(rbw get {} --field password --clipboard)+execute-silent(touch ${TIMESTAMP_FILE})+transform-input-label(echo \"Copied password\")"
        --bind="ctrl-o:execute-silent(rbw code {} --clipboard)+execute-silent(touch ${TIMESTAMP_FILE})+transform-input-label(echo \"Copied OTP\")"
